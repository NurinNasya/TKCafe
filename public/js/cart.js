...
if (window.cartInitialized) {
    ...
    //     // NEW FUNCTION: Handle Place Order
    // function placeOrder() {
    //     const btn = document.querySelector('.checkout-btn');
    //     if (!btn) {
    //         console.error('Checkout button not found!');
    ...
    /*const handleAddToCart = (button) => {
        ...
        if (isCombo) {
            ...
            cartData.customizations = { drink: selectedDrink.value };
        }
        ...
        fetch('/TKCafe/Controller/cartController.php', {
            ...
            body: new URLSearchParams({
                action: 'add',
                ...cartData,
                customizations: isCombo ? JSON.stringify(cartData.customizations) : null
            })
        })
        .then(response => response.json())
        .then(data => {
...
//     placeOrder(); // ✅ Call your main function
//   });
// });
