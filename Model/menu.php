...
function addMenuItem($conn, $name, $description, $price, $category, $image) {
    $name = mysqli_real_escape_string($conn, $name);
    $description = mysqli_real_escape_string($conn, $description);
    $category = mysqli_real_escape_string($conn, $category);
    $image = mysqli_real_escape_string($conn, $image);
    $price = (float)$price;
    //$created_by = mysqli_real_escape_string($conn, $create_by);
...
function updateMenuItem($conn, $id, $name, $description, $price, $category, $image) {
    $id = (int)$id;
    $name = mysqli_real_escape_string($conn, $name);
    $description = mysqli_real_escape_string($conn, $description);
    $category = mysqli_real_escape_string($conn, $category);
    $image = mysqli_real_escape_string($conn, $image);
    $price = (float)$price;
    //$updated_by = mysqli_real_escape_string($conn, $update_by);
